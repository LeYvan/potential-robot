	...
	<nav class="navbar navbar-default navbar-static-top">
	  <div class="container">
	    ...
	    <div class="navbar-header">
	      ...
	      <a class="navbar-brand" href="#">FaireFace</a>
	    </div>

	    <!-- Collect the nav links, forms, and other content for toggling -->
	    <div class="collapse navbar-collapse" id="bs-faireface-navbar-collapse-1">
	      <ul class="nav navbar-nav">
	        <li class="active"><a href="#">Alertes <span class="sr-only">(current)</span></a></li>
	        <li><a href="#">Nouvelles</a></li>
	        <li><a href="#">Capsules</a></li>
	        <li><a href="#">Plan Familial</a></li>
	      </ul>
	      <ul class="nav navbar-nav navbar-right">
	        <li><a href="#">Avertir</a></li>
	      </ul>
	    </div><!-- /.navbar-collapse -->
	  </div><!-- /.container-fluid -->
	</nav>
  	<div id="page" class="container">
		...
		<div class="panel panel-default">
		  <div class="panel-heading">
		    <h3 class="panel-title">Il y a une inondation sur la rue Ste-Catherine</h3>
		  </div>
